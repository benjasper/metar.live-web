...
const tag = cva(
	'flex items-center gap-2 rounded-full border px-4 py-1.5 text-xs font-medium transition-all duration-200',
	{
		variants: {
			...
			intent: {
				standard:
					'border-slate-300/60 bg-slate-50/80 text-slate-800 dark:border-white/10 dark:bg-white/10 dark:text-white-dark',
				successful:
				...
				neutral:
					'border-slate-300/60 bg-slate-100/60 text-slate-800 dark:border-slate-500/40 dark:bg-slate-600/30 dark:text-white-dark',
			},
		},
		defaultVariants: {
			intent: 'standard',
